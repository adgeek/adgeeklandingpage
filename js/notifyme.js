    ...
    e.fn.notifyMe = function(t) {
        ...
        e(this).on("submit", function(t) {
            ...
            if (p.test(h)) {
                ...
                e.ajax({
                    type: "POST",
                    url: "https://script.google.com/macros/s/AKfycbz_gGsV4fARj3zJODyAPRvkW_SVBHu_FxvC4Wsi2AScnnKSW2Y/exec",
                    data: {
                        email: h
                    },
                    dataType: "json",
                    ...
                    if (e.result == "success") {
                        ...
                        $(".message").html('<p class="notify-valid">Congrats! You are in the list.<br>We will inform you as soon as we finish.</p>').fadeIn();
                    } else {
